defmodule IslandsEngine.Board do
  ...
  # TODO: Check this function if is already used and needed
  # def all_islands_forested?(board), do: Enum.all?(Island.types, &(Map.has_key?(board, &1)))

  def all_islands_positioned?(board), do: Enum.all?(Island.type, &(Map.has_key?(board, &1)))
